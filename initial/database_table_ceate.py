...
def run():
    ...
    Uesr_session.execute(
        'create table user_get_prize( id serial not null primary key, phone varchar(20) not null, shopping_area_en_name varchar(20) not null, prize varchar(80) not null, prize_id varchar(255) not null, redeem INT(10) not null);')
    Uesr_session.execute(
